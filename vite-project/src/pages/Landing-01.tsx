...
const Landing: React.FC = () => {
  ...
  return (
    <Layout title="Welcome to POSgpt">
      <style>{`
        header.sticky-blend {
      ...
      <main className="flex-1 w-full">
        ...
        >
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <BuildingStorefrontIcon className="h-20 w-20 mx-auto text-white" />
            </motion.div>
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight">
            Streamline Your Business with an AI-Powered, Cloud-Based POS System
            </h1>
